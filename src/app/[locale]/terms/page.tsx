    ...
    <div className="min-h-screen">
      <main className="container mx-auto px-4 pb-16 max-w-4xl">
        ...
        >
          ...
          >
            <div className="w-20 h-20 mx-auto bg-linear-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center shadow-2xl">
              <FileText className="w-10 h-10 text-white" />
            </div>
          </motion.div>
          <h1 className="text-5xl font-bold mb-3 bg-linear-to-r from-purple-600 to-pink-600 dark:from-purple-400 dark:to-pink-400 bg-clip-text text-transparent">
            {t("title")}
          </h1>
        ...
        >
          ...
          <div className="relative overflow-hidden rounded-3xl bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl border border-gray-200/50 dark:border-gray-700/50 p-8 shadow-xl">
            <div className="absolute -top-20 -right-20 w-40 h-40 bg-linear-to-tr from-purple-600/20 to-pink-600/20 rounded-full blur-3xl" />
          ...
          {sections.map((section, index) => (
            ...
            >
              <div className="absolute -bottom-10 -right-10 w-32 h-32 bg-linear-to-tr from-purple-600/10 to-pink-600/10 rounded-full blur-3xl" />
          ...
          <motion.div
            ...
            className="relative overflow-hidden rounded-3xl bg-linear-to-r from-purple-600 to-pink-600 p-8 shadow-2xl text-white text-center"
          >
